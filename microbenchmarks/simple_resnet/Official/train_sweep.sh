...
test_dir_name="train_sweep_0_resnet_offical"
...
global_opt="--data_dir=$data_dir --cache_records=False --benchmark_num_elements=1500000 --dataset_threadpool_size=16 --time_limit_s=72 --percentage_cached=0.0 --map_and_batch_fusion=True"
