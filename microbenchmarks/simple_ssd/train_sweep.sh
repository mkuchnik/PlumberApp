...
test_dir_name="train_sweep_0_ssd_test"
...
global_opt="--use_cache=True --benchmark_num_elements=10000 --dataset_threadpool_size=16 --time_limit_s=62 --map_and_batch_fusion=True"
