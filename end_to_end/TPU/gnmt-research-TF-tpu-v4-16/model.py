...
#from tensorflow.compat.v1.contrib import seq2seq as contrib_seq2seq
from tensorflow_addons import seq2seq as contrib_seq2seq
...
class BaseModel(object):
  ...
  def __init__(self, hparams, mode, features):
    ...
    if self.mode == contrib_learn.ModeKeys.PREDICT:
